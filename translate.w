...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1" style="background-color:#F2F2F2;">
   ...
   <div class="x-titlebar-left" xid="left2">
    <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon" label="返回" xid="button1" icon="icon-chevron-left">
     <i xid="i3" class="icon-chevron-left"></i>
     <span xid="span6">返回</span></a> </div> 
   <div class="x-titlebar-title" xid="title2">
    <span xid="span7">问题反馈</span></div> 
   ...
   <div class="x-col" xid="col18"><textarea component="$UI/system/components/justep/textarea/textarea" xid="suggestTextarea" placeHolder="请详细描述你的问题或建议。。。" class="form-control"></textarea></div></div>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row4">
   <div class="x-col" xid="col10"><div xid="div14">
